...
class AchievementRepository(BaseRepository[models.Achievement]):
    ...
    def get_criteria_by_type(self, criterion_type: str) -> List[models.AchievementCriterion]:
        ...
        return self.db.query(models.AchievementCriterion)\
    ...
    def get_user_achievements(self, user_id: int) -> List[models.UserAchievement]:
        ...
        return self.db.query(models.UserAchievement)\
            .options(joinedload(models.UserAchievement.achievement))\
            .filter(models.UserAchievement.user_id == user_id)\
            .all()
    
    def get_user_achievement(self, user_id: int, achievement_id: int) -> Optional[models.UserAchievement]:
    ...
    def get_user_progress(self, user_id: int, criterion_id: int) -> Optional[models.UserAchievementProgress]:
        ...
        return self.db.query(models.UserAchievementProgress)\
            .filter(
